...
export const CITIES: Record<string, CityConfig> = {
  helsinki: {
    ...
    metaTitle: "Joukkoliikenne Helsingissä - Bussit, ratikat, metro ja junat reaaliajassa",
    metaDescription:
      "Katso HSL:n bussien, ratikoiden, metron ja lähijunien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses, trams, metro & trains in Helsinki.",
  ...
  tampere: {
    ...
    metaTitle: "Joukkoliikenne Tampereella - Bussit ja ratikat reaaliajassa",
    metaDescription:
      "Katso Tampereen Nysse-bussien ja ratikoiden aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses & trams in Tampere.",
  ...
  turku: {
    ...
    metaTitle: "Joukkoliikenne Turussa - Föli aikataulut reaaliajassa",
    metaDescription:
      "Katso Turun Föli-bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt Turun seudulla. | Real-time buses in Turku.",
  ...
  oulu: {
    ...
    metaTitle: "Joukkoliikenne Oulussa - OSL aikataulut reaaliajassa",
    metaDescription:
      "Katso Oulun bussien aikataulut reaaliajassa. Näe lähimmät OSL-pysäkit ja seuraavat lähdöt. | Real-time buses in Oulu.",
  ...
  jyvaskyla: {
    ...
    metaTitle: "Joukkoliikenne Jyväskylässä - Linkki aikataulut reaaliajassa",
    metaDescription:
      "Katso Jyväskylän Linkki-bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses in Jyväskylä.",
  ...
  lahti: {
    ...
    metaTitle: "Joukkoliikenne Lahdessa - LSL aikataulut reaaliajassa",
    metaDescription:
      "Katso Lahden bussien aikataulut reaaliajassa. Näe lähimmät LSL-pysäkit ja seuraavat lähdöt. | Real-time buses in Lahti.",
  ...
  kuopio: {
    ...
    metaTitle: "Joukkoliikenne Kuopiossa - Vilkku aikataulut reaaliajassa",
    metaDescription:
      "Katso Kuopion Vilkku-bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses in Kuopio.",
  ...
  lappeenranta: {
    ...
    metaTitle: "Joukkoliikenne Lappeenrannassa - Jouko aikataulut reaaliajassa",
    metaDescription:
      "Katso Lappeenrannan Jouko-bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses in Lappeenranta.",
  ...
  hameenlinna: {
    ...
    metaTitle: "Joukkoliikenne Hämeenlinnassa - Bussiaikataulut reaaliajassa",
    metaDescription:
      "Katso Hämeenlinnan bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses in Hämeenlinna.",
  ...
  pori: {
    ...
    metaTitle: "Joukkoliikenne Porissa - Bussiaikataulut reaaliajassa",
    metaDescription:
      "Katso Porin bussien aikataulut reaaliajassa. Näe lähimmät pysäkit ja seuraavat lähdöt. | Real-time buses in Pori.",
